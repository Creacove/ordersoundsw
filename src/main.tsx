...
import { publicEnv, configError } from "./config/publicEnv.ts"
import { ConfigErrorUI } from "./components/utils/ConfigErrorUI.tsx"
...
if (configError) {
  root.render(<ConfigErrorUI issues={configError} />);
} else {
  root.render(
    <BrowserRouter>
