...
export default function EmailMarketing() {
    ...
    // Protect Route (Simple check, real protection should be in Layout/Route guard)
        ...
        <MainLayout>
            <div className="container py-8 max-w-4xl">
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground mt-2">Send newsletters and updates to your users.</p>
                </div>
                ...
                <div className="grid gap-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Create a new email broadcast. Supports basic HTML.</CardDescription>
                        </CardHeader>
