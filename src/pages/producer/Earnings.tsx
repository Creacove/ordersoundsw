    ...
    return (
        <MainLayout>
            <div className="container py-6 md:py-8 space-y-8">
                <div>
                    <h1 className="heading-responsive-lg text-3xl font-bold tracking-tight">
                        Earnings
                        <span className="text-muted-foreground font-normal text-xl ml-2">
                            ({currency === 'NGN' ? 'NGN' : 'USD'})
                        </span>
                    </h1>
                    <p className="text-muted-foreground mt-2">Track your revenue, sales performance, and payouts in {currency}.</p>
                </div>
                        ...
                        <CardContent>
                            {statsLoading ? (
                                ...
                                <>
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">
                                        Total beats purchased ({currency})
                                    </p>
                                </>
                            )}
                        </CardContent>
                ...
                <div className="grid grid-cols-1 gap-4">
                    <EarningsChart data={stats?.revenueByMonth || []} loading={statsLoading} currency={currency} />
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>History of funds transferred to your bank account (All Currencies)</CardDescription>
                    </CardHeader>
                    <CardContent>
                        {payoutsLoading ? (
